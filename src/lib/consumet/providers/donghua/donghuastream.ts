...
class DonghuaStream extends AnimeParser {
  override readonly name = 'DonghuaStream';
  protected override baseUrl = 'https://donghuastream.org';
  protected override logo = 'https://donghuastream.org/favicon.ico';
  protected override classPath = 'DONGHUA.DonghuaStream';
