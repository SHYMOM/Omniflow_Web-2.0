...
import { getTopRatedAnime } from '@/lib/api/anilist';
...
export default function TopRatedPage() {
  ...
  const {
    ...
    queryFn: ({ pageParam = 1 }) => getTopRatedAnime(24, pageParam).then(res => res.map(mapAniListToMediaItem)),
    initialPageParam: 1,
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-6 pt-20">
      <h1 className="text-2xl font-bold text-white mb-2 font-display">Top Rated Streams</h1>
      <p className="text-xs text-text-secondary mb-6">Highest critically acclaimed media items reviewed by international communities</p>
