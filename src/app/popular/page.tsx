...
export default function PopularPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-6 pt-20">
      <h1 className="text-2xl font-bold text-white mb-2 font-display">All Time Popular</h1>
      <p className="text-xs text-text-secondary mb-6">The most widely followed and bookmarked cinematic series across our entire platform</p>
