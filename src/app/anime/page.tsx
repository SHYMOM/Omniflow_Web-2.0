...
export default function AnimeLandingPage() {
  ...
  async function loadMore() {
    ...
    setLoading(true);
    try {
      const res = await getPopularAnime(24, page);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-6 pt-20">
      <div className="mb-8">
        ...
        <p className="text-xs text-text-secondary">Explore spectacular animated series spanning top-tier Japanese production studios</p>
      </div>
