...
export default function UpcomingPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-6 pt-20">
      <h1 className="text-2xl font-bold text-white mb-2 font-display">Top Upcoming</h1>
      <p className="text-xs text-text-secondary mb-6">Highly anticipated streams scheduled for upcoming broadcasting</p>
